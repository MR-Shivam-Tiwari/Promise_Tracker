                    ...
                    <div> 
                        <div className="max-w-md flex gap-3 mx-auto">
                            <div className="relative">
                                ...
                                <input type="search" id="default-search" className="w-[260px] p-2 ps-10 text-sm text-gray-900 border border-gray-300 border-[3px]  lg:rounded-lg rounded-[3px]" placeholder="Search By Name, Email, Role" onChange={HandleSearch} />
                            </div>
                        </div>
                    </div>
                </div>
