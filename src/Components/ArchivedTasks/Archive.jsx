                ...
                <div className="w-full max-w-8xl mx-auto   ">
                    <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {archiveTasks.map((task, index) => (
                            <div key={index} className="bg-[#EF7F1A4D] lg:h-[38vh] rounded-lg p-4 shadow-md">
                                <div className="flex items-center justify-between mb-4">
                                    <div className='flex font-bold items-center gap-3 text-black text-sm'>
                                        <div className='flex'>
                                            ...
                                            {truncateText (task?.taskGroup.groupName , 10)}
                                        </div>
                                        <span className="px-2 rounded-sm text-sm font-bold text-gray-800 bg-[#1525804d]">
                                            {task?.status}
                                        </span>
                                    </div>
                                    <Dropdown>
