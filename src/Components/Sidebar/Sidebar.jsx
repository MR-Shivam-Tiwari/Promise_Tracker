        ...
        >
            ...
            >
                ...
                >
                    ...
                    <ListItem nested onClick={() => { navigate('/home'); handleItemClick('home') }}>
                        <Toggler
                            renderToggle={({ open, setOpen }) => (
                                <ListItemButton selected={selectedItem === 'home'} className='p-2 px-3' onClick={() => setOpen(!open)}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
                                        <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z" />
                                    </svg>
                                    <ListItemContent>

                                        <Typography style={{ fontSize: "17px", fontWeight: "bold" }} >Home</Typography>
                                    </ListItemContent>
                    ...
                    <ListItem nested onClick={() => { navigate('/task'); handleItemClick('task') }}>
                        <Toggler
                            renderToggle={({ open, setOpen }) => (
                                <ListItemButton selected={selectedItem === 'task'} className='p-2 px-3' onClick={() => setOpen(!open)}>
                                    ...
                                    <ListItemContent>
                                        ...
                                        <Typography style={{ fontSize: "17px", fontWeight: "bold" }}>Task</Typography>
                                    </ListItemContent>
                    ...
                    {showButton && (
                        <ListItem nested onClick={() => { navigate('/roles'); handleItemClick('roles') }}>
                            <Toggler
                                renderToggle={({ open, setOpen }) => (
                                    <ListItemButton selected={selectedItem === 'roles'} className='p-2 px-3' onClick={() => setOpen(!open)}>
                                        ...
                                        <ListItemContent>
                                            ...
                                            <Typography style={{ fontSize: "17px", fontWeight: "bold" }}>Roles</Typography>
                                        </ListItemContent>
                    ...
                    <ListItem nested onClick={() => { navigate('/approvals'); handleItemClick('approvals') }}>
                        <Toggler
                            renderToggle={({ open, setOpen }) => (
                                <ListItemButton selected={selectedItem === 'approvals'} className='p-2 px-3' onClick={() => setOpen(!open)}>
                                    ...
                                    <ListItemContent>
                                        ...
                                        <Typography style={{ fontSize: "17px", fontWeight: "bold" }}>Approvals</Typography>
                                    </ListItemContent>
                    ...
                    <ListItem nested onClick={() => { navigate('/archive-task'); handleItemClick('archive-task') }}>
                        <Toggler
                            renderToggle={({ open, setOpen }) => (
                                <ListItemButton selected={selectedItem === 'archive-task'} className='p-2 px-3' onClick={() => setOpen(!open)}>
                                    ...
                                    <ListItemContent>
                                        ...
                                        <Typography style={{ fontSize: "17px", fontWeight: "bold" }}>Archive Tasks</Typography>
                                    </ListItemContent>
                        ...
                        renderToggle={({ open, setOpen }) => (
                            <ListItemButton selected={selectedItem === 'settings'} className='flex p-2 px-4 rounded-md bg-gray-100  items-center ' onClick={() => setOpen(!open)}>
                                <ListItemContent>
                                    ...
                                    <Typography style={{ fontSize: "20px", fontWeight: "bold" }}>Settings</Typography>
                                </ListItemContent>
            ...
            <div className=''>
                ...
                <ListItem nested onClick={() => { navigate('/profile'); handleItemClick('profile'); }} >
                    <Toggler
                        renderToggle={({ open, setOpen }) => (
                            <ListItemButton selected={selectedItem === 'profile'} className='flex p-2 px-4 rounded-md bg-gray-100  items-center ' onClick={() => setOpen(!open)}>
                                <ListItemContent>
            ...
            <ListItemButton selected={selectedItem === 'Logout'} className='flex p-2 px-4 rounded-md bg-blue-100  items-center ' onClick={handleLogout}>
                <ListItemContent>

                    <Typography style={{ fontSize: "20px", fontWeight: "bold" }}>Logout</Typography>
                </ListItemContent>
