        ...
        >
            ...
            >
                ...
                >
                    ...
                    <ListItem nested onClick={() => navigate('/home')}>
                        <Toggler
                            renderToggle={({ open, setOpen }) => (
                    ...
                    <ListItem nested onClick={() => navigate('/task')}>
                        <Toggler
                            renderToggle={({ open, setOpen }) => (
                    ...
                    <ListItem nested onClick={() => navigate('/approvals')}>
                        <Toggler
                            renderToggle={({ open, setOpen }) => (
                                <ListItemButton onClick={() => setOpen(!open)}>
                    ...
                    <ListItem nested onClick={() => navigate('/profile')}>
                        <Toggler
                            renderToggle={({ open, setOpen }) => (
                                <ListItemButton onClick={() => setOpen(!open)}>
